      ...
      <div className="space-y-2.5 p-3">
        <div className="space-y-2">
          <textarea
            ...
            rows={3}
            className="w-full resize-none rounded-lg border border-[var(--border-primary)]/60 bg-black/55 px-3 py-2.5 font-mono text-[12px] leading-relaxed tracking-[0.02em] text-[var(--text-primary)] outline-none placeholder:text-[var(--text-muted)]/55 focus:border-[var(--cyan-primary)]/80 focus:bg-black/70"
          />

          <div className="flex items-center justify-between gap-2">
            <span className="font-mono text-[7px] uppercase tracking-[0.18em] text-[var(--text-muted)]">
              ⌘ / ctrl + enter
            </span>
            ...
            <button
              ...
              className="min-w-[74px] rounded-md border border-[var(--cyan-primary)]/45 bg-[var(--cyan-primary)]/10 px-3 py-2 font-mono text-[9px] font-bold tracking-[0.18em] text-[var(--cyan-primary)] transition-colors hover:bg-[var(--cyan-primary)]/20 disabled:cursor-not-allowed disabled:opacity-40"
            >
              {loading ? (
